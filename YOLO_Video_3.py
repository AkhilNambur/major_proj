...
def video_detection_3(path_x):
    ...
    model = YOLO("../YOLO_Weights/best_final_final_Airforce.pt")
    classNames = ['AirForce-FighterAircraft-HALTejas','AirForce-FighterAircraft-Rafale','AirForce-GroundAttackAircraft-SEPECAT-Jaguar','AirForce-TransportAircraft-Antonov-An-32','AirForce-Helicopter-Boeing-CH-47','AirForce-Helicopter-Mil-Mi-17']
    ...
    while True:
        ...
        cv2.putText(img, f"Hash: {frame_hash}", (hash_x, hash_y), 0, 1.0, [0, 0, 0], thickness=1, lineType=cv2.LINE_AA)
        ...
        if any_class_detected:
            ...
            count_label = "No AirForce Detected"
