...
def video_detection_2(path_x):
    ...
    model = YOLO("../YOLO_Weights/best_final_final_navy.pt")
    classNames = ['Navy-Ariel-Aircraft-TU142M',
'Navy-Ariel-Helicopter-HALCHETAK',
'Navy-Ariel-Helicopter-SEAKING42',
'Navy-Sealevel-AircraftCarriers-VIKRAMADITYA',
'Navy-Sealevel-AircraftCarriers-VIRAAT',
'Navy-Sealevel-Frigates-TALWAR' ]
