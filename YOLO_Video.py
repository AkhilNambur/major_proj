...
def video_detection(path_x):
    ...
    model = YOLO("../YOLO_Weights/best_final_final_army.pt")
    classNames = ['Army-Ground-Armouredcombatvehicle-Arjun',
'Army-Ground-Armouredpersonnelcarrier-Casspir',
'Army-Aerial-Helicopters-Boeing-AH-64-Apache',
'Army-Ground-Armouredpersonnelcarrier-TataKestrel',
'Army-Ground-Armouredpersonnelcarrier-MahendraArmando',
'Army-Aerial-Drones-IAIHeronTP']
    ...
    while True:
        ...
        for r in results:
            ...
            for box in boxes:
                ...
                cv2.putText(img, label, (x1, y1 - 2), 0, 1.0, [255, 255, 255], thickness=1, lineType=cv2.LINE_AA)
        ...
        cv2.putText(img, f"Hash: {frame_hash}", (hash_x, hash_y), 0, 1.3, [0, 0, 0], thickness=1, lineType=cv2.LINE_AA)
        ...
        if any_class_detected:
            ...
            for class_name in classNames:
                if class_counts[class_name] > 0:
                    ...
                    line_number += 1
                    cv2.putText(img, f"{class_name}:{class_counts[class_name]}", (10, 30 + 25 * line_number), 0, 1.3,
                                [0, 0, 0], thickness=1, lineType=cv2.LINE_AA)
        else:
            count_label = "No Army Force"
